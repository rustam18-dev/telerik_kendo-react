...
export const DepositData = ({addDeposit}: Props) => {
  ...
  return <>
    <div className={stylesAction.actions}>
      ...
      <div className={stylesAction.actions__block}>
        ...
        <Button className='flex-center btn_small' fillMode={'flat'} onClick={addDeposit}>
          <CirclePlus size={12}/>
    ...
    <LayoutGridData client={handleSelectClient} employees={employees.slice(70, 80)}/>
  </>
}