...
export const Parameters = ({ onChange, value, selectedDeposit }: Props) => {
  ...
  useEffect(() => {
    if (selectedDeposit !== "00") {
      setParent("parameters_" + selectedDeposit)
    }
  }, [selectedDeposit])
        ...
        <div className={styles.parameters__items}>
          ...
          <p className={styles.parameters__technical_passport}>
            ...
            <TextBox
              ...
              value={value.technical_passport}
